...
import joblib
target = []
data = pd.read_excel(r"C:\Users\26446\WPSDrive\29182127\WPS\data.xlsx")
factors = []
for i in range(0,31):
    _ = []
...
print(model)
df = pd.read_excel(r"C:\Users\26446\WPSDrive\29182127\WPS\data 2.xlsx")
for i in range(len(ori_factors)):

    r = model.predict(np.array([ori_factors[i]]))[0]
    print(r)
    df.iloc[i,21] = r
df.to_excel(r"C:\Users\26446\WPSDrive\29182127\WPS\data 2.xlsx", index=False)
    \end{minted}
\end{listing}
\end{document}  