...
\begin{abstract}
    ...
    The adjustment of Olympic events is an important way for the continuous development of the Olympic Games. Adjusting the Olympic events is conducive to enhancing the social and contemporary value of the Olympics. This paper mainly uses the random forest regression model to evaluate and predict the increase or decrease of future Olympic events.
    ...
    \par For Task 4, we utilized the well-trained random forest regression model to identify three SDEs that may be added or reintroduced at the 2032 Brisbane Olympic Games and determined their priority recommendation order.
\end{abstract}
\tableofcontents
